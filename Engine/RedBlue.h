...
{
    if (*(DWORD*)(*Engine::CGame_Character::m_Master + 18304) & 256 ||
            *(DWORD*)(*Engine::CGame_Character::m_Master + 18304) & 268435456)
        return 0;
...
int __fastcall MyPlayerTick(void *pTarget, void *edx, unsigned int Value)
{
    ...
    if (*(int*)((int)pTarget + 19564) == 1 && *(int*)((int)pTarget + 20656) == 0 &&
            *(DWORD*)((int)pTarget + 19572))
    {
    ...
    if (*(DWORD*)((int)pTarget + 18256) & 262144)
    {
        if (*(DWORD *)((int)pTarget + 19828) == 0)
            SetTip((int)pTarget,*(const char**)((int)pTarget + 17592),
                    RGB(0,128,255),10000,false);
    }
...
signed int __cdecl MyIsPlayerAttack()
{
    ...
    if (*(DWORD*)(*Engine::CGame_Character::m_Master + 18256) & 262144 ||
            *(DWORD*)(*Engine::CGame_Character::m_Master + 18256) & 524288)
        Check = 1;

    return Check;
}

void *__fastcall MySetTip(int pTarget, void *edx, LPCTSTR pString, COLORREF color,
        int dwLife, int bShowName)
{
