void __fastcall ChatCommand(int Player, void *edx, const char *command)
{
	...
	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,5) == "/naro")
	{
		IPlayer.Teleport(0,258042,259367);
		return;
	}

	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,6) == "/cargo")
	{
		IPlayer.Teleport(0,265073,262622);
		return;
	}

	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,5) == "/fort")
	{
		IPlayer.Teleport(0,267586,242863);
		return;
	}

	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,5) == "/mine")
	{
		IPlayer.Teleport(0,266056,284973);
		return;
	}

	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,5) == "/bird")
	{
		IPlayer.Teleport(0,255764,288738);
		return;
	}

	if (IPlayer.IsOnline() && !CChar::IsGState((int)IPlayer.GetOffset(),2) && !CChar::IsGState((int)IPlayer.GetOffset(),256) && cmd.substr(0,4) == "/cop")
	{
