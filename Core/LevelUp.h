int __fastcall LevelUp(void *Player, void *edx)
{
	...
	if (IPlayer.IsOnline())
	{
		...
		{
			if (LevelReward.count(i) && (LevelReward.find(i)->second.Class == IPlayer.GetClass() || LevelReward.find(i)->second.Class == 4))
				IPlayer.GiveReward(LevelReward.find(i)->second.Index,LevelReward.find(i)->second.Prefix,LevelReward.find(i)->second.Amount,LevelReward.find(i)->second.Info,LevelReward.find(i)->second.Attack,LevelReward.find(i)->second.Magic,LevelReward.find(i)->second.Toa,LevelReward.find(i)->second.Upgrade,LevelReward.find(i)->second.Defense,LevelReward.find(i)->second.Evasion,LevelReward.find(i)->second.Endurance,LevelReward.find(i)->second.Msg.c_str());
		}
	}
