...
int __fastcall IsStateCheck(int Item, void *edx, int Value)
{
	...
	if (IItem.CheckIndex() >= 3381 && IItem.CheckIndex() <= 3383 && !CheckHaninMirror.find(*(DWORD*)(Item + 32))->second && IItem.GetInfo() & 1)
	...
	if (PetTime.count(IItem.CheckIndex()) || (IItem.CheckIndex() >= 1747 && IItem.CheckIndex() <= 1762) || (IItem.CheckIndex() >= 1870 && IItem.CheckIndex() <= 1877) || (IItem.CheckIndex() >= 2004 && IItem.CheckIndex() <= 2007) || (IItem.CheckIndex() >= 2421 && IItem.CheckIndex() <= 2423) || (IItem.CheckIndex() >= 2550 && IItem.CheckIndex() <= 2653) || (IItem.CheckIndex() >= 6045 && IItem.CheckIndex() <= 6052))
...
int __fastcall MyInventoryCheck(int Player, void *edx)
{
	...
	if (Size >= 60) Size -= 12;
	if (IPlayer.IsOnline() && IPlayer.IsBuff(172) && IPlayer.IsBuff(173) && IPlayer.IsBuff(174)) Size -= 108;
	if (IPlayer.IsOnline() && !IPlayer.IsBuff(172) && IPlayer.IsBuff(173) && IPlayer.IsBuff(174)) Size -= 72;
	if (IPlayer.IsOnline() && !IPlayer.IsBuff(172) && !IPlayer.IsBuff(173) && IPlayer.IsBuff(174)) Size -= 36;
	if (Size < 0) Size = 0;
	return Size;
}
...
{
	if (Type == -3 || Type == -97 || Type == -98 || Type == -99 || Type == -100 || Type == -101)
		return 0;
