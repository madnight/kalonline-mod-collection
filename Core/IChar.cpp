...
int IChar::Buff(int id, int time, int value)
{
    ...
    *(DWORD*)(AddBuff + 12) = value;
    (*(int (__thiscall **)(int,
                int))(*(DWORD *)(int)this->GetOffset() + 180))((int)this->GetOffset(),
                    AddBuff);
    return 1;
}
...
void IChar::DecreaseMana(int amount)
{
    if (this->IsOnline())
    {
        if (this->GetCurMp() >= amount) {
            (*(int (__cdecl **)(DWORD, signed int, DWORD,
                        int))(*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 8, 0,
                            amount);
        }
    }
}
...
void IChar::IncreaseMana(int amount)
{
    if (this->IsOnline()) {
        (*(int (__cdecl **)(DWORD, signed int, DWORD,
                    int))(*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 8, 1,
                        amount);
    }
}
...
{
    if (this->IsValid()) {
        CChar::WriteInSight(this->GetOffset(), 0x3f, "bddbbwwb", skillID, this->GetID(),
            Target.GetID(),
            Target.GetType(), SkillGrade, 0, 0, true);
    }
}
...
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, signed int, signed int,
                    __int32))(*(DWORD*)(int)this->GetOffset() + 92))((int)this->GetOffset(), 5, 0,
                        amount);
    }
}
...
void IChar::IncreaseMaxHp(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, signed int, signed int,
                    __int32))(*(DWORD*)(int)this->GetOffset() + 92))((int)this->GetOffset(), 5, 1,
                        amount);
    }
}
...
void IChar::DecreaseMaxMp(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, signed int, signed int,
                    __int32))(*(DWORD*)(int)this->GetOffset() + 92))((int)this->GetOffset(), 6, 0,
                        amount);
    }
}
...
void IChar::IncreaseMaxMp(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, signed int, signed int,
                    __int32))(*(DWORD*)(int)this->GetOffset() + 92))((int)this->GetOffset(), 6, 1,
                        amount);
    }
}
...
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(DWORD, signed int, DWORD,
                    signed int))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 1,
                        1, amount);
    }
}
...
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, DWORD, signed int,
                    signed int))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 0,
                        1, amount);
    }
}
...
void IChar::AddInt(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(DWORD, signed int, DWORD,
                    signed int))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 2,
                        1, amount);
    }
}
...
void IChar::AddWis(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(int, signed int, signed int,
                    signed int))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 3,
                        1, amount);
    }
}
...
void IChar::AddAgi(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(DWORD, signed int, DWORD,
                    DWORD))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 4, 1,
                        amount);
    }
}
...
void IChar::RemoveAgi(int amount)
{
    if (this->IsOnline()) {
        (*(void (__cdecl **)(DWORD, signed int, DWORD,
                    DWORD))(*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 4, 0,
                        amount);
    }
}
...
void IChar::AddFxToTarget(std::string effectName, bool AutoRemove,
    bool Continues, bool nForced)
{
    if (this->IsOnline())
    {
        if (this->IsBuff(159) || this->IsBuff(327) || this->IsBuff(329) ||
            this->IsBuff(331)) {
            return;
        }

        CChar::WriteInSight(this->GetOffset(), 0xFF, "ddsdddd", 239, this->GetID(),
            effectName.c_str(),
            AutoRemove, Continues, nForced, 0);
    }
}
...
void IChar::AddParticle(int Bone, const char *ParticleName)
{
    if (this->IsOnline() && !this->IsBuff(331)) {
        CChar::WriteInSight(this->GetOffset(), 0xFF, "dsdd", 247, ParticleName,
            *(DWORD *)((int)this->GetOffset() + 28), Bone);
    }
}
...
void IChar::SetMobTarget(int target)
{
    if (this->IsOnline() && this->IsValid())
    {
        ...
        {
            (*(void (__thiscall **)(int, DWORD))(*(DWORD *)this->GetOffset() + 132))
            ((int)this->GetOffset(), *(DWORD *)((int)this->GetOffset() + 464));
            (*(void (__thiscall **)(int, DWORD))(*(DWORD *)this->GetOffset() + 188))
            ((int)this->GetOffset(), 0);
            return;
        }
        ...
        if (!this->GetMobTanker() && target)
        {
            ...
            if (ITarget.IsValid())
            {
                if (CChar::GetRange((int)ITarget.GetOffset() + 332,
                        (int)this->GetOffset() + 332) <= 200)
                    (*(void (__thiscall **)(DWORD, DWORD))(*(DWORD *)(int)this->GetOffset() + 188))
                    ((int)this->GetOffset(), target);
            }
        }
    }
}
...
void IChar::UpdateHonor(int HP, int HK, int HD, int DKPT, int DKPW, int PLT,
...
void IChar::ShowHonor(int HP, int HK, int HD, int DKPT, int DKPW, int PLT,
    int PLW, int SVT, int SVW, int RP)
{
...
void IChar::RemoveSkillPoint(int amount)
{
    if (this->IsOnline())
    {
        if (this->GetSkillPoint() >= amount)
            (*(void (__cdecl **)(int, DWORD, signed int, signed int))
                (*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 24, 0, amount);
    }
}
...
void IChar::AddSkillPoint(int amount)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
            (*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 24, 1, amount);
}
...
{
    if (this->IsOnline())
        (*(int (__cdecl **)(DWORD, signed int, DWORD, int))
            (*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 23, 1, Amount);
}
...
void IChar::RemoveStatPoint(int Amount)
{
    if (this->IsOnline())
        (*(int (__cdecl **)(DWORD, signed int, DWORD, int))
            (*(DWORD *)(int)this->GetOffset() + 88))((int)this->GetOffset(), 23, 0, Amount);
}
...
void IChar::IncreaseStat(int amount, int Type)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
            (*(DWORD *)(this->GetOffset()) + 88))((int)(this->GetOffset()), Type, 1,
                amount);
}
...
void IChar::DecreaseStat(int amount, int Type)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
            (*(DWORD *)(this->GetOffset()) + 88))((int)(this->GetOffset()), Type, 0,
                amount);
}
...
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, signed int, signed int, int))
            (*(DWORD*)(int)this->GetOffset() + 88))((int)this->GetOffset(), 35, 1, amount);
}
...
void IChar::DecreaseRage(int amount)
{
    if (this->IsOnline())
    {
        if (this->GetRage() >= amount) {
            (*(void (__cdecl **)(int, signed int, signed int,
                        int))(*(DWORD*)(int)this->GetOffset() + 88))((int)this->GetOffset(), 35, 0,
                            amount);
        }
    }
}
...
void IChar::IncreaseHp(int amount)
{
    if (this->IsOnline())
    {
        ...
        (*(void (__cdecl **)(int, signed int, signed int, int))
            (*(DWORD*)(int)this->GetOffset() + 88))((int)this->GetOffset(), 7, 1, amount);
    }
}
...
void IChar::DecreaseHp(int amount)
{
    if (this->IsOnline())
    {
        if (this->GetCurHp() >= amount)
            (*(void (__cdecl **)(int, signed int, signed int, int))
                (*(DWORD*)(int)this->GetOffset() + 88))((int)this->GetOffset(), 7, 0, amount);
    }
}
...
int IChar::GetObjectListAround(int range)
{
    if (this->IsValid() && this->GetX() > 0 && this->GetY() > 0)
        return CPlayer::GetObjectAround(*(void **)
                ((int)this->GetOffset() + 320), (int)this->GetOffset() + 324, range);
    else {
        return 0;
    }
}
...
void IChar::SendGStateEx(__int64 state)
{
    if (this->IsValid() && !this->IsBuff(331))
    {
        ...
        if (!this->IsBuff(159) && !this->IsBuff(290) && !this->IsBuff(291) &&
            !this->IsBuff(292) && !this->IsBuff(293) && !this->IsBuff(294) &&
            !this->IsBuff(295)) {
            CChar::WriteInSight(this->GetOffset(), 148, "dI", this->GetID(), state);
        }
    }
...
{
    if (this->IsValid() && !this->IsBuff(331)) {
        CChar::WriteInSight(this->GetOffset(), 61, "db",
            *(DWORD *)((int)this->GetOffset() + 28), 0);
    }
}
...
int IChar::_ShowBattleMiss(IChar Target, int skillID)
{
    ...
    {
        (*(void (__thiscall **)(int, int))(*(DWORD*)Target.GetOffset() + 80))
        ((int)Target.GetOffset(), (int)this->GetOffset());
        ...
        if (Target.IsBuff(159)) {
            ...
            *(DWORD*)((int)this->GetOffset() + 28) == Target.GetID()) {
            ...
            return CChar::WriteInSight(this->GetOffset(), 0x3f, "bddbbwwb",
                    skillID, this->GetID(), Target.GetID(), Target.GetType(), 1, 0, 0, false);
    } else {
        return 0;
    }
}
...
int IChar::OktayDamageNoAgro(IChar Target, int Damage, int SkillID)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        ...
        if (CChar::GetRange((int)this->GetOffset() + 332,
                (int)Target.GetOffset() + 332) > 300) {
            return 0;
        }
        ...
        if ((*(int (__thiscall **)(void*))(*(DWORD *)(int)Target.GetOffset() + 0x40))(
                Target.GetOffset())) {
        ...
        if (Target.IsBuff(159) || (Target.IsBuff(327) && !Target.IsBuff(11) &&
                !Target.IsBuff(339) && !Target.IsBuff(348) &&
                !Target.IsBuff(350)) || (Target.IsBuff(329) &&
                !Target.IsBuff(11) && !Target.IsBuff(339) &&
                !Target.IsBuff(348) && !Target.IsBuff(350))) {
            return 0;
        }
        ...
        *(DWORD *)((int)Target.GetOffset() + 272) = Target.GetCurHp() - Damage;
        ...
        if (GiveCrit == true)
            CChar::WriteInSight(this->GetOffset(), 63, "bddbbwwb", SkillID,
                this->GetID(), Target.GetID(), 1, 1, Damage, 0, Target.GetType() + 2);
        else
            CChar::WriteInSight(this->GetOffset(), 10, "bbddww", Target.GetType(),
                SkillID, this->GetID(), Target.GetID(), Damage, 0);
...
int IChar::OktayDamageSingle(IChar Target, int Damage, int SkillID)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        if (this->IsValid() && this->GetClass() == 4 && this->GetSpecialty() == 23 &&
            Damage)
        {
            int pSkill = this->GetSkillPointer(49);

            if (pSkill) {
                Damage += (*(DWORD*)(pSkill + 8) * 50);
            }
        }
        ...
        if (Target.IsBuff(159) || (Target.IsBuff(327) &&
                !Target.IsBuff(11) && !Target.IsBuff(339) &&
                !Target.IsBuff(348) && !Target.IsBuff(350)) ||
            (Target.IsBuff(329) && !Target.IsBuff(11) &&
                !Target.IsBuff(339) && !Target.IsBuff(348) && !Target.IsBuff(350))) {
            return 0;
        }
        ...
        int NormalDamage = 0, DamageArgument = 0, EBDamage = 0;
        int Check = 0, TypeKind = 0, GetType = 0;
        TypeKind = (*(int (__thiscall **)(LONG,
                        void *))(*(DWORD *)Target.GetOffset() + 148))
        ...
        if ((this->GetClass() == 1 && SkillID == 67)) {
            ...
            EBDamage = GetASpeedValue * (*(int (__thiscall **)(void *, LONG))
...
void IChar::OktayDamageArea(IChar Target, int Damage, int SkillID)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        ...
        if (Target.IsBuff(159) || (Target.IsBuff(327) && !Target.IsBuff(11) &&
                !Target.IsBuff(339) &&
                !Target.IsBuff(348) && !Target.IsBuff(350)) || (Target.IsBuff(329) &&
                !Target.IsBuff(11) &&
                !Target.IsBuff(339) && !Target.IsBuff(348) && !Target.IsBuff(350))) {
            return;
        }
        ...
        unsigned int GetAttackSpeed = CChar::GetASpeed((int)this->GetOffset());
        unsigned int GetASpeedValue = GetAttackSpeed;
        int NormalDamage = 0, DamageArgument = 0, EBDamage = 0, Check = 0, TypeKind = 0,
            GetType = 0;
        TypeKind = (*(int (__thiscall **)(LONG,
                        void *))(*(DWORD *)Target.GetOffset() + 148))
            ((int)Target.GetOffset(), this->GetOffset());
        ...
        CChar::WriteInSight(this->GetOffset(), 10, "bbddww", GetType, SkillID,
            this->GetID(), Target.GetID(), NormalDamage, EBDamage);
    } else {
        return;
    }
}
...
void IChar::OktayDamageStorm(IChar Target, int Damage)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        ...
        TypeKind = (*(int (__thiscall **)(LONG, void *))
        ...
        CChar::WriteInSight(this->GetOffset(), 10, "bbddww", GetType, 500,
            this->GetID(), Target.GetID(), NormalDamage, 0);
...
void IChar::AddDeathBlow(int amount)
{
    if (this->IsOnline())
    {
        ...
        if (this->GetDeathBlow() < 5)
            (*(void (__cdecl **)(int, DWORD, signed int, signed int))
                (*(DWORD *)(int)(this->GetOffset()) + 92))((int)(this->GetOffset()), 36, 1,
                    amount);
    }
}
...
void IChar::RemoveDeathBlow(int amount)
{
    if (this->IsOnline())
    {
        ...
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
            (*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(), 36, 0, amount);
    }
}
...
int IChar::IsInRange(IChar Target, int maxRange)
{
    ...
    {
        if (CChar::GetRange((int)this->GetOffset() + 324,
                (int)Target.GetOffset() + 324) <= maxRange) {
            return 1;
        }
    }
    ...
    int CellMapCoordinate)
{
    if (this->IsOnline())
    {
        if (SafeZoneCheck)
        {
            if (!CSMap::IsOnTile(*(void **)(Monster + 320), Monster + 332, 131072) &&
                Undefined::CellMapCheck(*(void **)(Monster + 320), Monster,
                    (int)CellMapCoordinate))
            {
            ...
            if (Undefined::CellMapCheck(*(void **)(Monster + 320), Monster,
                    (int)CellMapCoordinate))
            {
                (*(void (__thiscall **)(int, DWORD))(*(DWORD *)Monster + 196))(Monster, 0);
                CChar::WriteInSight((void*)Monster,51,"wdddwddIIsbdsIIb",
    ...
    if (this->IsOnline())
    {
        ...
        *((DWORD *)this->GetOffset() + 69) = 0;
        ...
        (*(void (__cdecl **)(void *, signed int, signed int, int))
            (*(DWORD *)this->GetOffset() + 88))(this->GetOffset(), 7, 1,
                CChar::GetMaxHp((int)this->GetOffset()));

        (*(void (__cdecl **)(void *, signed int, signed int, int))
            (*(DWORD *)this->GetOffset() + 88))(this->GetOffset(), 8, 1,
...
void IChar::IncreaseCritRate(int Amount)
{
    if (this->IsOnline())
    {
        (*(void (__cdecl **)(DWORD, DWORD, DWORD, DWORD))(*(DWORD *)this->Offset + 96))
        ((int)this->Offset, 31, 1, Amount);
        (*(void (__thiscall **)(DWORD, DWORD, DWORD))(*(DWORD *)this->Offset + 104))
        ((int)this->Offset, 16, 0);
    }
}
...
void IChar::DecreaseCritRate(int Amount)
{
    ...
    {
        (*(void (__cdecl **)(DWORD, DWORD, DWORD, DWORD))(*(DWORD *)this->Offset + 96))
        ((int)this->Offset, 31, 0, Amount);
        (*(void (__thiscall **)(DWORD, DWORD, DWORD))(*(DWORD *)this->Offset + 124))
        ((int)this->Offset, 16, 0);
    }
}
...
{
    if (this->IsOnline())
        (*(void (__cdecl **)(DWORD, DWORD, DWORD,
                    DWORD))(*(DWORD*)(int)this->GetOffset() + 96))
        ((int)this->GetOffset(), 32, 1, amount);
}
...
void IChar::DecreaseMovingSpeed(int amount)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(DWORD, DWORD, DWORD,
                    DWORD))(*(DWORD*)(int)this->GetOffset() + 96))
        ((int)this->GetOffset(), 32, 0, amount);
}
...
std::string IChar::GetIP()
{
    ...
    if (this->IsOnline()) {
        Check = inet_ntoa(*(struct in_addr*)(*(DWORD*)((int)this->GetOffset() + 1676) +
                    140));
    }
...
void IChar::GiveReward(int Index, int Prefix, int Amount, int Info, int xAtk,
    int xMag, int TOA, int Upgr, int Def, int Eva, int Endurance, const char *msg)
{
    if (this->IsOnline())
    {
