...
void IChar::IncreaseStat(int amount, int Type)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
         (*(DWORD *)(this->GetOffset()) + 88))((int)(this->GetOffset()), Type, 1, amount);
}
...
void IChar::DecreaseStat(int amount, int Type)
{
    if (this->IsOnline())
        (*(void (__cdecl **)(int, DWORD, signed int, signed int))
         (*(DWORD *)(this->GetOffset()) + 88))((int)(this->GetOffset()), Type, 0, amount);
}
...
void IChar::SendGStateEx(__int64 state)
{
    if (this->IsValid() && !this->IsBuff(331))
    {
        ...
        if (!this->IsBuff(159) && !this->IsBuff(290) && !this->IsBuff(291) &&
                !this->IsBuff(292) && !this->IsBuff(293) && !this->IsBuff(294) && !this->IsBuff(295))
            CChar::WriteInSight(this->GetOffset(), 148, "dI", this->GetID(), state);
    }
}
...
void IChar::SetDirection(IChar Target)
{
    if (this->IsOnline() && this->IsValid() && Target.IsOnline())
        CChar::SetDirection(this->GetOffset(),*(DWORD *)
                ...
                *(DWORD *)((int)Target.GetOffset() + 336) - *(DWORD *)((int)this->GetOffset() + 336));
}
...
int IChar::OktayDamageSingle(IChar Target, int Damage, int SkillID)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        ...
        TypeKind = (*(int (__thiscall **)(LONG, void *))(*(DWORD *)Target.GetOffset() + 148))
        ...
        Check = (*(int (__thiscall**)(LONG,void*,unsigned int,int*,int*,int*, DWORD))
            ...
            ((int)Target.GetOffset(),this->GetOffset(),
             GetASpeedValue * Damage / GetAttackSpeed,&NormalDamage,&DamageArgument,&EBDamage,0);
...
void IChar::OktayDamageStorm(IChar Target, int Damage)
{
    ...
    if (this->IsOnline() && this->IsValid() && Target.IsValid())
    {
        ...
        TypeKind = (*(int (__thiscall **)(LONG, void *))
                (*(DWORD *)Target.GetOffset() + 148))((int)Target.GetOffset(), this->GetOffset());
...
void IChar::AddDeathBlow(int amount)
{
    if (this->IsOnline())
    {
        ...
        if(this->GetDeathBlow() < 5)
            (*(void (__cdecl **)(int, DWORD, signed int, signed int))
             (*(DWORD *)(int)(this->GetOffset()) + 92))((int)(this->GetOffset()), 36, 1, amount);
    }
}
...
void IChar::RemoveAbsorb(int amount)
{
    if (this->IsOnline())
        (*(int (__cdecl **)(int, signed int, signed int, DWORD, DWORD))
         (*(DWORD *)(int)this->GetOffset() + 92))((int)this->GetOffset(),16,0,amount,amount);
}
    ...
    if (this->IsOnline())
    {
        if (SafeZoneCheck)
        {
            if ( !CSMap::IsOnTile(*(void **)(Monster + 320), Monster + 332, 131072) &&
                    Undefined::CellMapCheck(*(void **)(Monster + 320), Monster, (int)CellMapCoordinate) )
            {
            ...
            if ( Undefined::CellMapCheck(*(void **)(Monster + 320), Monster, (int)CellMapCoordinate) )
            {
                ...
                CChar::WriteInSight((void*)Monster,51,"wdddwddIIsbdsIIb",
                        ...
                        *(DWORD *)(Monster + 292),
                        ...
                        (Monster),*(DWORD *)(*(DWORD *)(Monster + 440) + 64) | 0x80,*(DWORD *)(Monster + 524),
    ...
    if (this->IsOnline())
    {
        ...
        *((DWORD *)this->GetOffset() + 69) = 0;
        ...
        (*(void (__cdecl **)(void *, signed int, signed int, int))
         (*(DWORD *)this->GetOffset() + 88))(this->GetOffset(), 7, 1, CChar::GetMaxHp((int)this->GetOffset()));

        (*(void (__cdecl **)(void *, signed int, signed int, int))
         (*(DWORD *)this->GetOffset() + 88))(this->GetOffset(), 8, 1, CChar::GetMaxMp((int)this->GetOffset()));
...
{
    if (this->IsOnline())
        (*(void (__cdecl **)(DWORD, DWORD, DWORD, DWORD))(*(DWORD*)(int)this->GetOffset() + 96))
...
std::string IChar::GetIP()
{
    ...
    if (this->IsOnline())
        Check = inet_ntoa(*(struct in_addr*)(*(DWORD*)((int)this->GetOffset() + 1676) + 140));
    return Check;
}
