void __fastcall StormActivateShiny(IChar IPlayer, IChar Target)
{
    if (Target.IsValid() && IPlayer.IsValid()
        && CheckShiny.count((int)Target.GetOffset()))
    {
        if (CheckShiny.find((int)Target.GetOffset())->second.Delay >= GetTickCount()) {
            return;
        }

        if (CheckShiny.find((int)Target.GetOffset())->second.Target
            && Target.IsBuff(307))
        {
            ...
            if (IPlayer.IsValid() && Caster.IsValid() && Target.IsValid())
            {
                ...
                if (pSkill && Target.IsValid())
                {
                    ...
                    while (Around)
                    {
                        ...
                        if (Object.IsValid() && Caster.IsValid() && IPlayer.IsValid() &&
                            Target.IsValid() &&
                            (*(int (__thiscall **)(int, int, DWORD))
                                (*(DWORD *)Caster.GetOffset() + 176))
                            ((int)Caster.GetOffset(), (int)Object.GetOffset(), 0))
                        {
                            if (Target.GetType() == 0 && CChar::IsGState((int)IPlayer.Offset, 128) &&
                                !CChar::IsGState((int)Object.Offset, 128)) {
                            } else if (Target.GetType() == 0 &&
                                CChar::IsGState((int)Target.Offset, 256) &&
                                Object.GetID() != Target.GetID()) {
                            } else {

                                int nDmg = (IPlayer.GetMagic() * MLAMul) +
                                    (nSkillGrade * CTools::Rate(MLAMin, MLAMax));
                                ...
                                if (Object.GetType() == 0 && Caster.GetID() !=
                                    Object.GetID() && Object.GetID() != IPlayer.GetID()) {
            ...
            if (IPlayer.IsValid() && Caster.IsValid() && Target.IsValid())
            {
                ...
                if (pSkill && Target.IsValid())
                {
                    ...
                    while (Around)
                    {
                        ...
                        if (Object.IsValid() && Caster.IsValid() &&
                            IPlayer.IsValid() && Target.IsValid() &&
                            (*(int (__thiscall **)(int, int, DWORD))
                                (*(DWORD *)Caster.GetOffset() + 176))
                            ((int)Caster.GetOffset(), (int)Object.GetOffset(), 0))
                        {
                            if (Target.GetType() == 0 &&
                                CChar::IsGState((int)IPlayer.Offset, 128) &&
                                !CChar::IsGState((int)Object.Offset, 128)) {
                            } else if (Target.GetType() == 0 && CChar::IsGState((int)Target.Offset, 256)
                                && Object.GetID() != Target.GetID()) {
                            } else {
                                int nDmg = (IPlayer.GetMagic() * MLAMul) + (nSkillGrade * CTools::Rate(MLAMin,
                                            MLAMax));
                                ...
                                if (Object.GetType() == 0 && Caster.GetID() != Object.GetID()
                                    && Object.GetID() != IPlayer.GetID()) {
                                    Object.AddFxToTarget("davi_ef129", 1, 0, 0);
                                }
...
int __cdecl CMonsterMagicCreate(int Index, int Value, int Argument, int Arg,
    int Player, int Damage, int Time)
{
    int check = CMonsterMagic::Create(Index, Value, Argument, Arg, Player, Damage,
            Time);
                ...
                if (IPlayer.GetType() == 0 && IPlayer.IsValid() && IMonster.IsValid())
                {
                    if (IMonster.GetMobIndex() == 231)
                    {
                        ...
                        while (Around)
                        {
                            ...
                            if (Object.IsValid() && IPlayer.IsValid() && IMonster.IsValid()
                                && IMonster.GetOffset() != Object.GetOffset()
                                && (*(int (__thiscall **)(int, int, DWORD))
                    ...
                    if (IMonster.IsValid() && IMonster.GetMobIndex() == 228
                        && CheckShiny.count((int)IMonster.GetOffset())
                        && CheckShiny.find((int)IMonster.GetOffset())->second.Target)
                    {
                        ...
                        if (IPlayer.IsValid() && IMonster.IsValid())
                        {
                            ...
                            while (Around)
                            {
                                ...
                                if (IMonster.IsValid() && Object.IsValid() && IPlayer.IsValid()
                                    && IPlayer.GetOffset() != Object.GetOffset()
                                    && IMonster.GetOffset() != Object.GetOffset()
                                    && (*(int (__thiscall **)(int, int, DWORD))
                    ...
                    if (IPlayer.GetType() == 1 && IPlayer.IsValid() && IMonster.IsValid())
                    {
                        ...
                        while (Around)
                        {
                            ...
                            if (IPlayer.IsValid() && IPlayer.GetOffset() != Object.GetOffset()
                                && Object.GetType() == 0) {
