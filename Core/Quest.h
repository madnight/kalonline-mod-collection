            ...
            && RentArmor.find(Quest.GetIndex())->second.Index)
        {
            ...
            if (Armor)
            {
                ...
                *(DWORD*)(Armor + 116) = RentArmor.find(Quest.GetIndex())->second.Eva;
                ...
                if (ValidItem == 1)
                {
                    CDBSocket::Write(17, "ddbbb", *(DWORD *)(Armor + 36), *(DWORD *)(Armor + 32),
                        15,
                        *(DWORD *)(Armor + 108), 0);
                    CDBSocket::Write(17, "ddbbb", *(DWORD *)(Armor + 36), *(DWORD *)(Armor + 32),
                        10,
            ...
            && RentWeapon.find(Quest.GetIndex())->second.Index)
        {
            ...
            if (Weapon)
            {
                ...
                *(DWORD*)(Weapon + 124) = RentWeapon.find(Quest.GetIndex())->second.Upgrade;
                ...
                if (ValidItem == 1)
                {
                    CDBSocket::Write(17, "ddbbb", *(DWORD *)(Weapon + 36), *(DWORD *)(Weapon + 32),
                        27,
                        *(DWORD*)(Weapon + 100), 0);
                    CDBSocket::Write(17, "ddbbb", *(DWORD *)(Weapon + 36), *(DWORD *)(Weapon + 32),
                        28,
                    ...
                    CDBSocket::Write(17, "ddbbb", *(DWORD *)(Weapon + 36), *(DWORD *)(Weapon + 32),
                        9,
                        *(DWORD*)(Weapon + 112), 0);
                    CDBSocket::Write(28, "ddbb", *(DWORD *)(Weapon + 36), *(DWORD *)(Weapon + 32),
                        2,
                        *(DWORD*)(Weapon + 124));
