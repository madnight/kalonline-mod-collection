void __fastcall Quest(void *QuestOffset, void *edx, int PlayerOffset)
{
    ...
    if (IPlayer.IsOnline() && CheckDailyQuest.count(Quest.GetIndex())
            && CheckDailyQuest.find(Quest.GetIndex())->second > 0)
    {
        if (LevelDailyQuest.find(Quest.GetIndex())->second > IPlayer.GetLevel())
        {
            IPlayer.SystemMessage("Your level is not enough to accepted the quest!",
                                  TEXTCOLOR_RED);
            return;
        }

        if (PlayerQuest.find((Quest.GetIndex() * 1000000000000) +
        ...
        if (!PlayerQuest.count((Quest.GetIndex() * 1000000000000) + IPlayer.GetPID())
                || PlayerQuest.find((Quest.GetIndex() * 1000000000000) +
                                    IPlayer.GetPID())->second.Repeat < CheckDailyQuest.find(
                    Quest.GetIndex())->second)
        {
            PlayerQuest[(Quest.GetIndex() * 1000000000000) + IPlayer.GetPID()].Active = 1;
            PlayerQuest[(Quest.GetIndex() * 1000000000000) + IPlayer.GetPID()].MobAmount =
                0;
            CPlayer::Write(IPlayer.GetOffset(),255,"dddd",222,IPlayer.GetPID(),
                           Quest.GetIndex(),0);
            ...
            if (PlayerQuest.find((Quest.GetIndex() * 1000000000000) +
                        ...
                        Quest.GetIndex())->second)
            {
                int Time = (int)time(0) - PlayerQuest.find((Quest.GetIndex() * 1000000000000) +
                           IPlayer.GetPID())->second.Time;
                ...
                if (Time < 0)
                {
                    ...
                    std::string msg =
                        "Exceeded the maximum repeat limit of quest. You need to wait " + Int2String(
                            Day) + " Days " + Int2String(Hour) + " Hours " + Int2String(
                            Minute) + " Minutes " + Int2String(Second) + " Seconds.";
                    ...
                    PlayerQuest[(Quest.GetIndex() * 1000000000000) + IPlayer.GetPID()].Time =
                        (int)time(0) + DailyQuest.find(IPlayer.GetMobIndex())->second.Time;
                    IPlayer.StartQuest(Quest.GetIndex());
                    IPlayer.DailyQuestUpdate(Quest.GetIndex(),0,0,
                                             (int)time(0) + DailyQuest.find(IPlayer.GetMobIndex())->second.Time);
                }
            }
        }
    ...
    if (IPlayer.IsOnline()
            && Quest.GetIndex() == RentArmor.find(Quest.GetIndex())->second.Quest)
    {
        int DonationCoinCheck = CPlayer::FindItem(IPlayer.GetOffset(),DonationCoin,
                                RentArmor.find(Quest.GetIndex())->second.Coin);

        if (DonationCoinCheck
                && CPlayer::RemoveItem(IPlayer.GetOffset(), 9, DonationCoin,
                                       RentArmor.find(Quest.GetIndex())->second.Coin)
                && RentArmor.find(Quest.GetIndex())->second.Index)
        {
            int Armor = CItem::CreateItem(RentArmor.find(Quest.GetIndex())->second.Index,
                                          RentArmor.find(Quest.GetIndex())->second.Prefix, 1, -1);
            ...
            if (Armor)
            {
                ...
                *(DWORD*)(Armor + 116) = RentArmor.find(Quest.GetIndex())->second.Eva;
                ...
                if (ValidItem == 1)
                {
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(Armor + 36),*(DWORD *)(Armor + 32),15,
                                     *(DWORD *)(Armor + 108),0);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(Armor + 36),*(DWORD *)(Armor + 32),10,
                                     *(DWORD *)(Armor + 116),0);
                    PetLifeCheck[*(DWORD *)(Armor + 36)].Time = (int)time(0) + RentArmor.find(
                                Quest.GetIndex())->second.Time;
                    PetLifeCheck[*(DWORD *)(Armor + 36)].Player = (int)IPlayer.GetOffset();
                    CDBSocket::Write(89,"ddd",IPlayer.GetPID(),
    ...
    if (IPlayer.IsOnline()
            && Quest.GetIndex() == RentWeapon.find(Quest.GetIndex())->second.Quest)
    {
        int DonationCoinCheck = CPlayer::FindItem(IPlayer.GetOffset(),DonationCoin,
                                RentWeapon.find(Quest.GetIndex())->second.Coin);

        if (DonationCoinCheck
                && CPlayer::RemoveItem(IPlayer.GetOffset(), 9, DonationCoin,
                                       RentWeapon.find(Quest.GetIndex())->second.Coin)
                && RentWeapon.find(Quest.GetIndex())->second.Index)
        {
            int Weapon = CItem::CreateItem(RentWeapon.find(Quest.GetIndex())->second.Index,
                                           RentWeapon.find(Quest.GetIndex())->second.Prefix, 1, -1);
            ...
            if (Weapon)
            {
                ...
                *(DWORD*)(Weapon + 124) = RentWeapon.find(Quest.GetIndex())->second.Upgrade;
                ...
                if (ValidItem == 1)
                {
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(Weapon + 36),*(DWORD *)(Weapon + 32),27,
                                     *(DWORD*)(Weapon + 100),0);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(Weapon + 36),*(DWORD *)(Weapon + 32),28,
                                     *(DWORD*)(Weapon + 104),0);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(Weapon + 36),*(DWORD *)(Weapon + 32),9,
                                     *(DWORD*)(Weapon + 112),0);
                    CDBSocket::Write(28, "ddbb",*(DWORD *)(Weapon + 36),*(DWORD *)(Weapon + 32),2,
                                     *(DWORD*)(Weapon + 124));
                    PetLifeCheck[*(DWORD *)(Weapon + 36)].Time = (int)time(0) + RentWeapon.find(
                                Quest.GetIndex())->second.Time;
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == PLQuest)
    {
        ...
        {
            IPlayer.SystemMessage("You can not register while Protecting Leader running.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("Only guild leader can register for Protecting Leader.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("You already registered to Protecting Leader.",
                                  TEXTCOLOR_RED);
            return;
        } else {
            ...
            {
                ProtectLeaderName[IPlayer.GetGID()] = (char*)CPlayer::GetGuildName(
                        PlayerOffset);
                ProtectLeaderList.push_back(IPlayer.GetGID());
                IPlayer.SystemMessage("Successfully registered to Protecting Leader.",
                                      TEXTCOLOR_GREEN);
            } else {
                IPlayer.SystemMessage("Guild level is low for Protecting Leader registration.",
                                      TEXTCOLOR_RED);
            }
        }
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == ENPCQ)
    {
        ...
        if (!ENPCItemCheck)
        {
            IPlayer.SystemMessage("You do not have any event item to collect!",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        if (NPCEDailyLimit < ENPCDL)
        {
            if (ENPCItemCheck)
            {
                ...
                std::string msg = Int2String(CheckItem) +
                                  " event items have been collected from you. " + Int2String(
                                      NPCECollectedTotalItem) + " event items have been collected in total!";
                IPlayer.SystemMessage(msg,TEXTCOLOR_GREEN);
                (*(int (__thiscall **)(DWORD, void *, signed int,
                                       signed int))(*(DWORD*)ENPCItemCheck + 120))((int)ENPCItemCheck,
                                               IPlayer.GetOffset(),9,-CheckItem);
            }
            ...
            if (NPCECollectedTotalItem == ENPCIA)
            {
                if (NPCELeftTime > 0)
                    CPlayer::WriteAll(0xFF, "ds", 234,
                                      "[Exp Event NPC] Event time has been extended!");
                else
    ...
    {
        std::string msg = Int2String(NPCECollectedTotalItem) +
                          " event items have been collected in total!";
        IPlayer.SystemMessage(msg,TEXTCOLOR_GREEN);
        return;
    }

    if (IPlayer.IsOnline() && BufferCheck.count(Quest.GetIndex())
            && BufferCheck.find(Quest.GetIndex())->second.Index == Quest.GetIndex())
    {
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == LMSQuest)
    {
        ...
        {
            IPlayer.SystemMessage("Last Man Standing already running. Please try again later.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("Your level is not enough to register for Last Man Standing.",
                                  TEXTCOLOR_RED);
        } else {
            if (!LastManRegistration.find(IPlayer.GetPID())->second)
            {
                LastManRegistration[IPlayer.GetPID()] = 1;
                IPlayer.SystemMessage("Successfully registered to Last Man Standing.",
                                      TEXTCOLOR_GREEN);
            } else {
                IPlayer.SystemMessage("You already registered to Last Man Standing.",
                                      TEXTCOLOR_RED);
            }
        }
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == DTQuest)
    {
        ...
        {
            IPlayer.SystemMessage("Duel Tournament already running. Please try again later.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("Your level is not enough to register for Duel Tournament.",
                                  TEXTCOLOR_RED);
        } else {
            if (!DuelTournamentRegistration.find(IPlayer.GetPID())->second)
            {
                ...
                IPlayer.SystemMessage("Successfully registered to Duel Tournament.",
                                      TEXTCOLOR_GREEN);
                DuelTournament::RegisterAmount += 1;
            } else {
                IPlayer.SystemMessage("You already registered to Duel Tournament.",
                                      TEXTCOLOR_RED);
            }
        }
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == HellQuest)
    {
        ...
        {
            IPlayer.SystemMessage("Picture Of Hell already running. Please try again later.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        if (IPlayer.IsOnline() && IPlayer.IsParty())
        {
            ...
            {
                IPlayer.SystemMessage("You are not the party leader to start Picture Of Hell.",
                                      TEXTCOLOR_RED);
                return;
            }
                    ...
                    i = CBaseList::Pop((void *)i))
            {
                ...
                if (CChar::IsNormal(Members) && IPlayer.IsValid())
                {
                    ...
                    {
                        IPlayer.SystemMessage("Some of your party members levels are not enough.",
                                              TEXTCOLOR_RED);
                        return;
                    }
                    ...
                    {
                        IPlayer.SystemMessage(
                                "Some of your party members have time limit to re-join Picture Of Hell.",
                                              TEXTCOLOR_RED);
                        return;
                    }
                }
            ...
            IPlayer.SystemMessage("You need a party to start Picture Of Hell.",
                                  TEXTCOLOR_RED);
            return;
        }
    ...
    if(IPlayer.IsOnline() && Quest.GetIndex() == F10Quest)
    {
        if (F10::Active == true)
        {
            IPlayer.SystemMessage("You can not register while Company System running.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("You already registered to Company System.",
                                  TEXTCOLOR_RED);
            return;
        } else {
            F10Registration[IPlayer.GetPID()] = 1;
            F10::RegisterAmount += 1;
            IPlayer.SystemMessage("Successfully registered to Company System.",
                                  TEXTCOLOR_GREEN);
            return;
        }
    ...
    {
        if (ScenarioRegistration.find(IPlayer.GetPID())->second
        ...
        {
            IPlayer.SystemMessage("You can not register while Destructing Key Points running.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        if (IPlayer.IsOnline() && IPlayer.GetPID() != IPlayer.GetGID())
        {
            IPlayer.SystemMessage("Only guild leader can register for Destructing Key Points.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        {
            IPlayer.SystemMessage("You already registered to Destructing Key Points.",
                                  TEXTCOLOR_RED);
            return;
        } else {
            int PlayerGuild = CPlayer::GetGuildName(PlayerOffset);
            ...
            if (IPlayer.IsOnline() && PlayerGuild)
            {
                ...
                ScenarioGuildName[Scenario::RegisterAmount] = (char*)CPlayer::GetGuildName(
                            PlayerOffset);
                IPlayer.SystemMessage("Successfully registered to Destructing Key Points.",
                                      TEXTCOLOR_GREEN);
            } else {
                IPlayer.SystemMessage("Guild level is low for Destructing Key Points registration.",
                                      TEXTCOLOR_RED);
            }
        }
    ...
    {
        if (HonorShop.find(Quest.GetIndex())->second > CheckHonor.find(
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == BFQuest)
    {
        ...
        {
            IPlayer.SystemMessage("You can not register while Battlefield running.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        if (BattlefieldRegistration.find(IPlayer.GetPID())->second)
        {
            ...
            IPlayer.SystemMessage("Successfully registered to Battlefield.",
                                  TEXTCOLOR_GREEN);
            return;
        }
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == EmokQuestIndex)
    {
        ...
        if (IPlayer.IsOnline()
                ...
                && CheckEmok.find(IPlayer.GetPID())->second.Time > 10)
        {
    ...
    if (IPlayer.IsOnline() && Quest.GetIndex() == MysteryQuest)
    {
        ...
        int MysteryItemCheck = CPlayer::FindItem(IPlayer.GetOffset(),MysteryResetItem,
                               1);

        if (!MysteryItemCheck)
        {
            IPlayer.SystemMessage("You do not have Stone of chance for Mystery Skill to reset.",
                                  TEXTCOLOR_RED);
            return;
        }
        ...
        if (IPlayer.IsOnline() && OTP)
        {
            ...
            *(DWORD*)(OTP + 8) = 0;
            ...
            CDBSocket::Write(22,"dbbw",IPlayer.GetPID(),*(DWORD*)(OTP + 4),
                             *(DWORD*)(OTP + 8),*(DWORD*)((int)IPlayer.GetOffset() + 548));
        ...
        if (IPlayer.IsOnline() && EVA)
        {
            ...
            *(DWORD*)(EVA + 8) = 0;
            ...
            CDBSocket::Write(22,"dbbw",IPlayer.GetPID(),*(DWORD*)(EVA + 4),
                             *(DWORD*)(EVA + 8),*(DWORD*)((int)IPlayer.GetOffset() + 548));
        ...
        if (IPlayer.IsOnline() && DEF)
        {
            ...
            *(DWORD*)(DEF + 8) = 0;
            ...
            CDBSocket::Write(22,"dbbw",IPlayer.GetPID(),*(DWORD*)(DEF + 4),
                             *(DWORD*)(DEF + 8),*(DWORD*)((int)IPlayer.GetOffset() + 548));
            *(DWORD*)((int)IPlayer.GetOffset() + 4 * *(DWORD*)(DEF +4) + 632) = 0;
        }

        (*(int (__thiscall **)(DWORD, void *, signed int,
                               signed int))(*(DWORD*)MysteryItemCheck + 120))(MysteryItemCheck,
                                       IPlayer.GetOffset(),9,-1);
        return;
    }
