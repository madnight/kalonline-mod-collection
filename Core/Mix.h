                        ...
                        int Stone, int Weapon, int NextStone)
{
    ...
    CIOCriticalSection::Enter((struct _RTL_CRITICAL_SECTION *)((
                                  int)pPlayer + 1020));
    int MixCheck = 0,a = 0,b = 0,c = 0,d = 0,e = 0,f = 0,g = 0,h = 0,i = 0,j = 0,
    ...
    *(DWORD*)&MixCheck = 0;
    ...
    if (success == false)
    {
        ...
        } else
        {
            ...
            CDBSocket::Write(3,"ddwdbddd",Itemd.GetIID(),IPlayer.GetID(),Itemd.CheckIndex(),
                             1,27,0,0,0);
                           ...
                           int ItemIndex, int DemonSword, int Item, int NextItem, char Stone)
{
    ...
    CIOCriticalSection::Enter((struct _RTL_CRITICAL_SECTION *)((
                                  int)pPlayer + 1020));
    int MixCheck = 0,a = 0,b = 0,c = 0,d = 0,e = 0,f = 0,g = 0,h = 0,i = 0,j = 0,
        k = 0,l = 0,m = 0,n = 0,o = 0,p = 0,r = 0,s = 0,t = 0,u = 0,v= 0, y = 0,z = 0;
    *(DWORD*)&MixCheck = 0;
    bool success = false;
    ...
    if ( success == false )
    {
        ...
        int Value = *(DWORD*)(d + 100) & 0xFF | ((*(DWORD*)(d + 84) & 0xFF) << 8) | ((*
                    (DWORD*)(d + 92) & 0xFF) << 16) | (z << 24);
        int Argument = ((*(DWORD*)(d + 112) & 0xFF) << 8) | (*(DWORD*)(d + 104) << 24);
        CDBSocket::Write(21,"dddbwddb",Itemd.GetIID(),IPlayer.GetID(),Itemd.GetInfo(),1,
