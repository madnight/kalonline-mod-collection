        ...
        if (Player.IsBuff(256))
        {
                    ...
                    && CheckHaninMirror.find(Player.GetPID())->second)
            {
                ...
                if (Stat && Mirror.CheckIndex() == 3381)
                {
                    ...
                    if (Type == 12) Player.CancelBuff(418);
    ...
    if (Player.IsOnline())
    {
                ...
                && CheckHaninMirror.find(Player.GetPID())->second)
        {
            ...
            if (Stat && Mirror.CheckIndex() == 3381)
            {
                ...
                if (Type == 12 && !Player.IsBuff(418)) Player.IncreaseMovingSpeed((3*Stat)+0.5);
                if (Type == 12) Player.Buff(418,1296000,0);
            ...
            if (Stat && Mirror.CheckIndex() == 3382)
            {
                ...
                if (Type == 12 && !Player.IsBuff(418)) Player.IncreaseMovingSpeed((3*Stat)+1.5);
                if (Type == 12) Player.Buff(418,1296000,0);
            ...
            if (Stat && Mirror.CheckIndex() == 3383)
            {
                ...
                if (Type == 12 && !Player.IsBuff(418)) Player.IncreaseMovingSpeed((3*Stat)+2.5);
                if (Type == 12) Player.Buff(418,1296000,0);
        ...
        if (Item.CheckIndex() >= 2986 && Item.CheckIndex() <= 3009)
        {
            ...
            if (Item.CheckIndex() == 2986) TrigramHP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[0][GetCurrentGrade];
            if (Item.CheckIndex() == 2994) TrigramHP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[1][GetCurrentGrade];
            if (Item.CheckIndex() == 3002) TrigramHP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[2][GetCurrentGrade];
            if (Item.CheckIndex() == 2987) TrigramMP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[3][GetCurrentGrade];
            if (Item.CheckIndex() == 2995) TrigramMP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[4][GetCurrentGrade];
            if (Item.CheckIndex() == 3003) TrigramMP[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[5][GetCurrentGrade];
            if (Item.CheckIndex() == 2988) TrigramAtk[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[6][GetCurrentGrade];
            if (Item.CheckIndex() == 2996) TrigramAtk[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[7][GetCurrentGrade];
            if (Item.CheckIndex() == 3004) TrigramAtk[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[8][GetCurrentGrade];
            if (Item.CheckIndex() == 2989) TrigramStr[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[9][GetCurrentGrade];
            if (Item.CheckIndex() == 2997) TrigramStr[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[10][GetCurrentGrade];
            if (Item.CheckIndex() == 3005) TrigramStr[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[11][GetCurrentGrade];
            if (Item.CheckIndex() == 2990) TrigramAgi[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[12][GetCurrentGrade];
            if (Item.CheckIndex() == 2998) TrigramAgi[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[13][GetCurrentGrade];
            if (Item.CheckIndex() == 3006) TrigramAgi[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[14][GetCurrentGrade];
            if (Item.CheckIndex() == 2991) TrigramInt[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[15][GetCurrentGrade];
            if (Item.CheckIndex() == 2999) TrigramInt[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[16][GetCurrentGrade];
            if (Item.CheckIndex() == 3007) TrigramInt[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[17][GetCurrentGrade];
            if (Item.CheckIndex() == 2992) TrigramWis[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[18][GetCurrentGrade];
            if (Item.CheckIndex() == 3000) TrigramWis[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[19][GetCurrentGrade];
            if (Item.CheckIndex() == 3008) TrigramWis[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[20][GetCurrentGrade];
            if (Item.CheckIndex() == 2993) TrigramHth[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[21][GetCurrentGrade];
            if (Item.CheckIndex() == 3001) TrigramHth[*(DWORD*)((int)Itemx + 32)] =
                    TriagramStats[22][GetCurrentGrade];
            if (Item.CheckIndex() == 3009) TrigramHth[*(DWORD*)((int)Itemx + 32)] =
        ...
        {
            if (Item.CheckIndex() >= 2004 && Item.CheckIndex() <= 2007)
                CPlayer::Write(Player.GetOffset(),221,"dwdb",Player.GetID(),Item.CheckIndex(),
                               Item.GetIID(),2);
            else
                CPlayer::Write(Player.GetOffset(),221,"dwdb",Player.GetID(),Item.CheckIndex(),
                               Item.GetIID(),0);
