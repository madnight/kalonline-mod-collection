...
int __cdecl NewItem(int Value)
{
	if (*(DWORD *)(Value + 68) == -1)
	{
		...
		if ((int)GetPointer)
		{
			...
			if (PetTime.count(xItem.CheckIndex()) || (xItem.CheckIndex() >= 1747 && xItem.CheckIndex() <= 1762) || (xItem.CheckIndex() >= 1870 && xItem.CheckIndex() <= 1877) || (xItem.CheckIndex() >= 2004 && xItem.CheckIndex() <= 2007) || (xItem.CheckIndex() >= 2421 && xItem.CheckIndex() <= 2423) || (xItem.CheckIndex() >= 2550 && xItem.CheckIndex() <= 2653) || (xItem.CheckIndex() >= 6045 && xItem.CheckIndex() <= 6052))
			{
...
int __fastcall ItemOnTimer(int Item, void *edx, int Argument)
{
	...
	if (!CBase::IsDeleted(Item) && (PetTime.count(IItem.CheckIndex()) || (IItem.CheckIndex() >= 1747 && IItem.CheckIndex() <= 1762) || (IItem.CheckIndex() >= 1870 && IItem.CheckIndex() <= 1877) || (IItem.CheckIndex() >= 2004 && IItem.CheckIndex() <= 2007) || (IItem.CheckIndex() >= 2421 && IItem.CheckIndex() <= 2423) || (IItem.CheckIndex() >= 2550 && IItem.CheckIndex() <= 2653) || (IItem.CheckIndex() >= 6045 && IItem.CheckIndex() <= 6052)))
	{
