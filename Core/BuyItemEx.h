signed int __fastcall PlayerRemoveItem(void *Player, void *edx, int Value, int Index, int Amount)
{
	...
	{
		if (IPlayer.GetMap() == BFMap || IPlayer.GetMap() == ScenarioMap || IPlayer.GetMap() == LMSMap || IPlayer.GetMap() == HellMap || IPlayer.GetMap() == PLMap)
		{
...
{
	if (Protect32::Active == true && Protect32::Time == 1200 && *(DWORD*)((int)NPC + 448) == PLRNPC && !*(DWORD *)((int)NPC + 480))
	{
		(*(void (__thiscall **)(DWORD, DWORD))(*(DWORD*)(int)NPC + 100))((int)NPC, 16);
		*(DWORD *)((int)NPC + 480) = 1197000 + GetTickCount();
	}

	if (Protect32::Active == true && Protect32::Time == 1200 && *(DWORD*)((int)NPC + 448) == PLBNPC && !*(DWORD *)((int)NPC + 480))
	{
		(*(void (__thiscall **)(DWORD, DWORD))(*(DWORD*)(int)NPC + 100))((int)NPC, 16);
		*(DWORD *)((int)NPC + 480) = 1197000 + GetTickCount();
	}
