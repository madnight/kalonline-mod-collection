signed int __fastcall WeaponChangePrefix(void *Item, void *edx, int Player,
    ...
    if (CurrentPrefix == NewPrefix)
    {
        ...
        if (IItem.GetEndurance() <= 0)
        {
            CPlayer::Write(IPlayer.GetOffset(), 91, "db",IItem.GetIID(),
                           IItem.GetEndurance());
            CDBSocket::Write(3,"ddwdbddd",IItem.GetIID(),IPlayer.GetID(),IItem.CheckIndex(),
                             1,27,0,0,0);
        ...
        if (CheckPimp.count(NewPrefix) && CheckPimp.find(NewPrefix)->second.Prefix)
        {
            ...
            CDBSocket::Write(17, "ddbbb",IItem.GetIID(),IPlayer.GetPID(),27,
                             IItem.GetTalismanOA(),0);
            CDBSocket::Write(17, "ddbbb",IItem.GetIID(),IPlayer.GetPID(),28,
                             IItem.GetTalismanOM(),0);
            CDBSocket::Write(17, "ddbbb",IItem.GetIID(),IPlayer.GetPID(),9,IItem.GetTOA(),
                             0);
            CDBSocket::Write(28, "ddbb",IItem.GetIID(),IPlayer.GetPID(),2,
                             IItem.GetUpgrade());
            CItem::SendItemInfo(IItem.GetOffset(), (int)IPlayer.GetOffset(), 92);
            return 1;
        }
        ...
        if (MixConfigPrefix.count(NewPrefix) && MixConfigPrefix.find(NewPrefix)->second)
        {
            ...
            CDBSocket::Write(21, "dddbb",IItem.GetIID(),IPlayer.GetID(),IItem.GetInfo(),0,
                             0);
            IItem.SetInfo(CurrentInfo + SetMixInfo);
            CDBSocket::Write(21, "dddbb",IItem.GetIID(),IPlayer.GetID(),
                             CurrentInfo + SetMixInfo,8,7);
            CItem::SendItemInfo(IItem.GetOffset(), (int)IPlayer.GetOffset(), 92);
                ...
                && WeaponReplaceIndex.count(IItem.CheckIndex()))
        {
            if (WeaponReplace.find(IItem.CheckIndex())->second == NewPrefix)
            {
                ...
                int ReplacePrefix = 0, ReplaceItem = 0, ReplaceInfo = 0, ReplaceA = 0,
                    ReplaceM = 0, ReplaceTOA = 0, ReplaceEB = 0, ReplaceGem = 0;
                ...
                if (!DeleteCheck)
                {
                    ...
                    if (ReplaceItem)
                    {
                        ...
                        *(DWORD *)(ReplaceItem + 84) = ReplaceGem;
                        ...
                        {
                            CConsole::Red("Real time weapon replace insert item Null error [PID (%d)] ",
                                          IPlayer.GetPID());
                        ...
                        CDBSocket::Write(17, "ddbbb",*(DWORD *)(ReplaceItem + 36),
                                         *(DWORD *)(ReplaceItem + 32),27,*(DWORD *)(ReplaceItem + 100),0);
                        CDBSocket::Write(17, "ddbbb",*(DWORD *)(ReplaceItem + 36),
                                         *(DWORD *)(ReplaceItem + 32),28,*(DWORD *)(ReplaceItem + 104),0);
                        CDBSocket::Write(17, "ddbbb",*(DWORD *)(ReplaceItem + 36),
                                         *(DWORD *)(ReplaceItem + 32),9,*(DWORD *)(ReplaceItem + 112),0);
                        CDBSocket::Write(28, "ddbb",*(DWORD *)(ReplaceItem + 36),
                                         *(DWORD *)(ReplaceItem + 32),2,*(DWORD *)(ReplaceItem + 124));
        ...
        if (NewPrefix == ImpConfigRead)
        {
            ...
            int ItemStat = GetItemStat.find(IItem.GetIID())->second;
            int GetWeaponGrade = *(DWORD*)(*(DWORD *)((int)Item + 40) + 80), Imp = 0,
                xMixPrefix = 0, ImpItem = 0;
            ...
            case 0x41:
                ...
                {
                    if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                            && IItem.CheckIndex() == 672 )
                        Imp = 801;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1677 )
                        Imp = 1821;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1678 )
                        Imp = 1822;
                    else
                        Imp = 800;
                } else {
            ...
            case 0x46:
                ...
                {
                    if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                            && IItem.CheckIndex() == 1698 )
                        Imp = 1853;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1705 )
                        Imp = 1823;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1706 )
                        Imp = 1824;
                    else
                        Imp = 1702;
                } else {
            ...
            case 0x4B:
                ...
                {
                    if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                            && IItem.CheckIndex() == 1917 )
                        Imp = 1924;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1918 )
                        Imp = 1925;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 1919 )
                        Imp = 1926;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == -1325 )
                        Imp = 4332;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == -1326 )
                        Imp = 4333;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == -1327 )
                        Imp = 4334;
            ...
            case 0x50:
                ...
                {
                    if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                            && IItem.CheckIndex() == 3029 )
                        Imp = 3036;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 3030 )
                        Imp = 3037;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 3031 )
                        Imp = 3038;
                    else
                        Imp = 3035;
                } else {
            ...
            case 0x5A:
                ...
                {
                    if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                            && IItem.CheckIndex() == 3150 )
                        Imp = 3158;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 3151 )
                        Imp = 3159;
                    else if ( *(DWORD *)(*(DWORD *)((int)Item + 40) + 96) == 1
                              && IItem.CheckIndex() == 3152 )
                        Imp = 3160;
                    else
                        Imp = 3157;
                } else {
            ...
            if (!DeleteCheck)
            {
                ...
                if (ImpItem)
                {
                    ...
                    CDBSocket::Write(87,"ddd",IPlayer.GetPID(),*(DWORD *)(ImpItem + 84),
                                     *(DWORD *)(ImpItem + 36));
                    CDBSocket::Write(21, "dddbb",*(DWORD *)(ImpItem + 36),*(DWORD *)(ImpItem + 32),
                                     *(DWORD *)(ImpItem + 48),8,7);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(ImpItem + 36),*(DWORD *)(ImpItem + 32),
                                     27,*(DWORD *)(ImpItem + 100),0);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(ImpItem + 36),*(DWORD *)(ImpItem + 32),
                                     28,*(DWORD *)(ImpItem + 104),0);
                    CDBSocket::Write(17, "ddbbb",*(DWORD *)(ImpItem + 36),*(DWORD *)(ImpItem + 32),
                                     9,*(DWORD *)(ImpItem + 112),0);
                    CDBSocket::Write(28, "ddbb",*(DWORD *)(ImpItem + 36),*(DWORD *)(ImpItem + 32),2,
                                     *(DWORD *)(ImpItem + 124));
