char ConfigCheck[50], ConfigClient[50], ConfigEngine[50], ConfigConfig[50], ConfigMConfig[50], ConfigEpk[50], SinCheck[50], PlayerCheck[50], Active2ndPwd[50], ThiefActiveCheck[50], ShopRewardCheck[50], LicenseSerial[75];
std::string Door = "Hell", Door2 = "Hell", Door3 = "Hell", Door4 = "Hell", Door5 = "Hell", Door6 = "Hell", Door7 = "Hell", Door8 = "Hell";
...
int MysteryResetItem = 0, MysteryQuest = 0; bool LicenseSerialCheck = false;
...
void ReadConfig()
{
	...
	GetPrivateProfileStringA("License", "Serial", "UNKNOWN", LicenseSerial, 75, "./Core.ini");
	...
	if (oItemShop != NULL)
	{
		...
		while (fgets(line, sizeof line, oItemShop) != NULL)
		{
			...
			if (sscanf(line, "(itemshop (billcode %d)(priority %d)(type %d)(price %d)(discount %d)(itemindex %d)(amount %d))", &BillCode, &Priority, &Type, &Price, &Discount, &ItemIndex, &Amount) == 7)
			{
				...
				Tools->Compile(ItemShopPacket+(count*12),"wbbbbbdb",BillCode,Priority,0,0,0,Type,Price,Discount);
