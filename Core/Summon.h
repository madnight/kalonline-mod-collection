        ...
        if (F10::KillCount < 2)
        {
            ...
            if (IMonster.IsValid() && Check == 3691)
                CPlayer::WriteInMap(21, 0xFF, "dsd", 247,
                    "I have a supernatural feeling that something invisible is trying to embody.",
                    1);
            ...
            if (IMonster.IsValid() && Check == 3676)
                CPlayer::WriteInMap(21, 0xFF, "dsd", 247,
                    "Whatever you have a qualification and an ability to defeat energy of evil.",
                    1);
                    ...
                    || !F10::Dunamic))
            {
                ...
                if (!F10::Dunamic)
                {
                    ...
                    if (Dunamic.IsValid()) {
                        Undefined::MonsterPath(*(void **)(F10::Dunamic + 320), F10::Dunamic, 0, -1, 0,
                            1);
                    }
                }
            }
            ...
            if (IMonster.IsValid() && Check == 3646) {
                Undefined::MonsterPath(*(void **)((int)Monster + 320), (int)Monster, 0, 120, 0,
                    1);
            }
