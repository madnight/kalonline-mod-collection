...
void __cdecl Mods::Player::SendCreate(void *player, unsigned char Type, char* format, long id, char* name, unsigned char _class, long x, long y, long z, unsigned short direction, unsigned long gState, unsigned char* Items, int ItemsLen, char face, char hair, unsigned __int64 mState64, char* GuildTitle, char* GuildName, long GuildID, char flag, long flagIndex)
{
	Server::CPlayer::Write(player, 0x32, "dsbdddwImbbIssdbdddII", id, name, _class, x, y, z, direction,
		(unsigned __int64)gState, Items, 16, face, hair, mState64, GuildTitle, GuildName, GuildID, flag, flagIndex,
		0, 0, (__int64)0, (__int64)0);
}

void __cdecl Mods::Player::SendExclusiveCreate(unsigned char Type, void *player, long id, char* name, unsigned char _class, long x, long y, long z, unsigned short direction, unsigned long gState, unsigned char* Items, int ItemsLen, char face, char hair, unsigned __int64 mState64, char* GuildTitle, char* GuildName, long GuildID, char flag, long flagIndex)
{
