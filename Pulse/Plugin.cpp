...
extern "C"
{
	__declspec(dllexport) unsigned long __cdecl nGetPluginID() { return PLUGIN_ID; }
	__declspec(dllexport) const char* __cdecl nGetPluginName() { return PluginName; }
	__declspec(dllexport) const char* __cdecl nGetPluginDescription() { return PluginDescription; }
	__declspec(dllexport) const char* __cdecl nGetPluginAuthor() { return PluginAuthor; }
	__declspec(dllexport) const char* __cdecl nGetPluginVersion() { return PluginVersion; }
};
