...
{
    this->m_Patches[Destination] = new Patch(Destination, (unsigned char*)const_cast<char*>(Data),
            Size, Recoverable);
}
...
void IMemory::Hook(unsigned long Address, void *Destination, unsigned char Instruction,
                   size_t Size, bool Recoverable)
{
...
void IMemory::Hook(void *Address, unsigned long Destination, unsigned char Instruction,
                   size_t Size, bool Recoverable)
{
...
void IMemory::Hook(unsigned long Address[], size_t Count, unsigned long Destination,
                   unsigned char Instruction, size_t Size, bool Recoverable)
{
    for(size_t i=0; i < Count; i++)
